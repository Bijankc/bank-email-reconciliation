/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f6441fc0da1b69d06a5a7f9854037554)
// Runtime types generated with workerd@1.20260903.1 2026-08-22 
interface __BaseEnv_Env {
	AUDIT: R2Bucket;
	DB: D1Database;
	TXN_QUEUE: Queue;
	SIMULATOR_TOKEN: string;
	OPERATOR_TOKEN: string;
	SIMULATOR_SCOPE: string;
	ACCOUNT_LEDGER: DurableObjectNamespace<import("./src/index").AccountLedger>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AccountLedger";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SIMULATOR_TOKEN" | "OPERATOR_TOKEN" | "SIMULATOR_SCOPE">> {}
}
